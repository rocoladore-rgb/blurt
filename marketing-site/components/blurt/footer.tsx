      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-2">
            ...
            <a href="#download"     className="text-sm text-muted-text hover:text-white transition-colors">Download</a>
            <a href="#features"     className="text-sm text-muted-text hover:text-white transition-colors">Features</a>
            <a href="https://github.com" className="text-sm text-muted-text hover:text-white transition-colors">GitHub</a>
          </div>
        </div>
